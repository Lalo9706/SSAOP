        ...
        <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white dark:bg-gray-800 shadow-md overflow-hidden sm:rounded-lg">
            ...
            <form method="POST" action="{{ route('obras.store') }}" enctype="multipart/form-data">
                ...
                <div x-data="{ activeTab: 'tab1' }">
                    ...
                    <div class="flex border-b-2 border-gray-800  dark:border-white">
                        <button type="button"
                        @click="activeTab = 'tab1'" 
                        :class="{
                            'bg-gray-800 text-white dark:bg-gray-100 dark:text-black font-bold': activeTab === 'tab1',
                            'bg-gray-100 text-black dark:bg-gray-900 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700': activeTab !== 'tab1'
                        }" 
                        class="py-2 px-4 focus:outline-none rounded-tl-lg rounded-tr-lg">
                            Datos Básicos
                        </button>
                        ...
                        :class="{
                            'bg-gray-800 text-white dark:bg-gray-100 dark:text-black font-bold': activeTab === 'tab2',
                            'bg-gray-100 text-black dark:bg-gray-900 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700': activeTab !== 'tab2'
                        }" 
                        class="py-2 px-4 focus:outline-none rounded-tl-lg rounded-tr-lg">
                        ...
                        :class="{
                            'bg-gray-800 text-white dark:bg-gray-100 dark:text-black font-bold': activeTab === 'tab3',
                            'bg-gray-100 text-black dark:bg-gray-900 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700': activeTab !== 'tab3'
                        }" 
                        class="py-2 px-4 focus:outline-none rounded-tl-lg rounded-tr-lg">
                            Metas
                        </button>
                    ...
                    <div x-show="activeTab === 'tab1'">
                        ...
                        <div x-data="localidades">
                            ...
                            <div class="py-2">
                                ...
                                class="block mt-1 h-full w-full border-gray-900 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm 
                                bg-white text-black dark:bg-gray-800 dark:text-white dark:border-gray-100">
                            ...
                            <div class="py-2">
                                ...
                                bg-white text-black dark:bg-gray-800 dark:text-white dark:border-gray-600" :disabled="!localidades.length">
                                    ...
                                    <template x-for="localidad in localidades" :key="localidad.id">
                                        <option :value="localidad.id" x-text="localidad.clave_localidad + ' ' +localidad.nombre_localidad"></option>
                                    </template>
                                </select>
                            </div>
                        </div>
